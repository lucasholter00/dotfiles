...
function jfxrun {
    javac --module-path /Users/lucasholter/javafx-sdk-19/lib --add-modules javafx.controls,javafx.fxml $1.java; java --module-path /Users/lucasholter/javafx-sdk-19/lib --add-modules javafx.controls,javafx.fxml $1 
}
...
function gitcrcob {
  git branch $1; git pull origin $1
}
...
function ardf {
    ...
    avrdude -F -V -c arduino -p ATMEGA328P -P /dev/cu.usbmodem1301 -b 115200 -U flash:w:$1.hex;
    rm $1 $1.o $1.hex;
}
